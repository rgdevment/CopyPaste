...
class CompactTheme extends AppThemeData {
  ...
  AppThemeTypography get typography => const AppThemeTypography(
        fontFamily: 'Inter',
        cardContent: TextStyle(fontSize: 13, height: 1.5, fontWeight: FontWeight.w400),
        cardHeader: TextStyle(fontSize: 10.5, fontWeight: FontWeight.w700),
        cardLabel: TextStyle(fontSize: 10.5, fontWeight: FontWeight.w700, letterSpacing: 0.06),
