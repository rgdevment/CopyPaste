...
1. **I'll investigate** — Gather context, talk to people involved, and assess the situation.
2. **I'll take action** — Depending on severity:
...
3. **I'll follow up** — If you reported the issue, I'll let you know the outcome (within privacy limits).
...
This Code of Conduct is adapted from the [Contributor Covenant](https://www.contributor-covenant.org/), version 2.1, with modifications to reflect the values and spirit of the **CopyPaste** project.
