...
- **Your data is untouched.** History, images and settings stay in
  ...
  you want to keep it.
- **Bug reports for Linux are not accepted.** The Linux code, packaging and CI remain in the git
  history up to `v2.11.0` for anyone who wants to fork and continue it; the GPL v3 licence covers
  exactly that.
